...
-- Create Foreign Key for employees table
...
-- Create Foreign Key for shops table 
ALTER TABLE shops
...
-- Insert values into shops table
INSERT INTO shops VALUES(1, 'Common Grounds', NULL);

-- Employees table Foreign Key update to connect with Primary Key Shops table 
UPDATE employees
SET coffeeshop_id = 1 
...
-- Shops Foreign Key Update to conncet with Primary Key locations 
UPDATE shops
SET city_id = 1
